...
class ExportQueryBuilderProviderCompilerPath implements CompilerPassInterface
{
    const ADAPTERS_TAG = 'orocrm_dotmailer.export.query_builder_adapter';
    const REGISTRY = 'orocrm_dotmailer.export.query_builder_adapter.registry';
