...
use OroCRM\Bundle\DotmailerBundle\Entity\Repository\AddressBookRepository;
use OroCRM\Bundle\DotmailerBundle\Entity\Repository\AddressBookContactRepository;
...
class SyncManager
{
    ...
    {
        $forceSync = $this->configManager->get('orocrm_dotmailer.force_sync_for_virtual_fields');
