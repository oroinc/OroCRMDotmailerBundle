...
use OroCRM\Bundle\DotmailerBundle\Model\ExtendDataFieldMapping;

/**
 * @ORM\Entity(repositoryClass="OroCRM\Bundle\DotmailerBundle\Entity\Repository\DataFieldMappingRepository")
 * @ORM\Table(
