...
import SegmentComponent from 'orosegment/js/app/components/segment-component';
...
import FieldChoiceItemView from 'orodotmailer/js/app/views/field-choice-item-view';
import MappingModel from 'orodotmailer/js/app/models/mapping-model';
