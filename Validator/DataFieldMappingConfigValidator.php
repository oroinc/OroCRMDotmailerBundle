...
namespace OroCRM\Bundle\DotmailerBundle\Validator;
...
{
    const ALIAS = 'orocrm_dotmailer.validator.datafield_mapping_config';
    ...
    protected function isFieldsTypeCompatible(DataFieldMappingConfig $entity)
    {
        ...
        if (count($fields) > 1 && $type !== DataField::FIELD_TYPE_STRING) {
            ...
            return $this->translator->trans('orocrm.dotmailer.datafieldmappingconfig.validation.multiple');
        }
        ...
        if (!$isCompatible) {
            ...
            $message = $this->translator->trans(
                'orocrm.dotmailer.datafieldmappingconfig.validation.incompatible_types_' . strtolower($type),
