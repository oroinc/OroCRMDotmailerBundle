...
use OroCRM\Bundle\DotmailerBundle\EventListener\AddDefaultMappingListener;
...
class AddDefaultMappingListenerTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->registry = $this->getMockBuilder('Doctrine\Common\Persistence\ManagerRegistry')
            ->getMock();
        $this->mappingListener = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\EventListener\MappingUpdateListener')
            ->disableOriginalConstructor()->getMock();
    ...
    public function testAfterSyncFinishedWhenApplicable()
    {
        ...
        $channelRepository = $this->getMockBuilder('Oro\Bundle\IntegrationBundle\Entity\Repository\ChannelRepository')
            ->disableOriginalConstructor()->getMock();
        $dataFieldRepository = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\Entity\Repository\DataFieldRepository')
            ->disableOriginalConstructor()->getMock();
        $dataFieldMappingRepository = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\Entity\Repository\DataFieldMappingRepository')
            ->disableOriginalConstructor()->getMock();
        $this->registry->expects($this->any())->method('getRepository')->will($this->returnValueMap(
            [
                ...
                ['OroCRMDotmailerBundle:DataField', null, $dataFieldRepository],
                ['OroCRMDotmailerBundle:DataFieldMapping', null, $dataFieldMappingRepository]
            ]
        ));
        $channel = new Channel();
