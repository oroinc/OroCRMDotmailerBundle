...
namespace OroCRM\Bundle\DotmailerBundle\Tests\Unit\Processor;

use OroCRM\Bundle\DotmailerBundle\Entity\AddressBookContact;
use OroCRM\Bundle\DotmailerBundle\Entity\ChangedFieldLog;
use OroCRM\Bundle\DotmailerBundle\Processor\MappedFieldsChangeProcessor;
...
class MappedFieldsChangeProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->queryConverter = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\QueryDesigner\ParentEntityFindQueryConverter')
    ...
    public function testProcessFieldChangesQueue()
    {
        ...
        $abContactRepository = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\Entity\Repository\AddressBookContactRepository')
            ->disableOriginalConstructor()
            ->getMock();
