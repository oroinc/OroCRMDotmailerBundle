...
use OroCRM\Bundle\DotmailerBundle\Provider\Transport\Iterator\AbstractMarketingListItemIterator;
use OroCRM\Bundle\DotmailerBundle\Provider\Transport\Iterator\UpdateEntityFieldsFromContactIterator;
...
class UpdateEntityFieldsFromContactIteratorTest extends \PHPUnit_Framework_TestCase
{
    public function testIterator()
    {
        ...
        $contactsToUpdateFromQB = $this->getMockBuilder('Doctrine\ORM\QueryBuilder')
            ...
            ->getMock();
        $repository = $this
            ->getMockBuilder('OroCRM\Bundle\DotmailerBundle\Entity\Repository\ContactRepository')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $registry->expects($this->any())->method('getRepository')->with('OroCRMDotmailerBundle:Contact')
