...
use OroCRM\Bundle\DotmailerBundle\Form\Type\DataFieldSelectType;
...
class DataFieldSelectTypeTest extends FormIntegrationTestCase
{
    ...
    public function testDefaultOptions()
    {
        ...
        $expectedOptions = [
            ...
            'grid_name'          => 'orocrm_dotmailer_datafield_grid',
            'configs'            => [
                'placeholder'  => 'orocrm.dotmailer.datafield.select.placeholder',
            ]
        ];
